          ...
          {featured.map((article, index) => (
            <Reveal as="li" key={article.slug} delay={index * 70} className="h-full">
              ...
              >
                ...
                <h3 className="mt-3 flex-1 font-semibold leading-snug text-ink group-hover:text-primary">{article.title[cl]}</h3>
                <p className="mt-3 line-clamp-2 text-sm leading-relaxed text-muted-foreground">{article.intro[cl]}</p>
