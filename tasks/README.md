...
| 52 | `52-sogou-verification.md` | TECHNICAL_SEO | `codex/52-sogou-verification` | APPROVED |
...
| --- | --- | --- | --- | --- |
| `sys-auto-001-codex-autonomous-workflow-bootstrap` | `sys-auto-001-codex-autonomous-workflow-bootstrap.md` | ORCHESTRATOR | `codex/sys-auto-001-bootstrap` | IN_PROGRESS / CORRECT |
